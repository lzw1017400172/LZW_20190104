...
import com.lzw.core.util.ExportCSVExcelUtil;
...
public class Export2007ExcelUtil {
	...
	public static void demo(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			Export2007ExcelUtil.writeExcel(response, fileName, sheetName, columnNames, sheetTitle, objects, false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
