...
import com.lzw.core.exception.DataParseException;
import com.lzw.core.exception.InstanceException;
...
public final class InstanceUtil {
     ...
     */
    @SuppressWarnings("unchecked")
    public static final <E> ArrayList<E> newArrayList(Set<E> set) {
        ArrayList<E> list = new ArrayList<E>();
        list.addAll(set);
        return list;
    }
