package com.lzw.core.support.jpush;
...
import com.lzw.core.config.SessionManager;
import com.lzw.core.support.jpush.model.MessageEntry;
...
public class MessageSender{
	 ...
	 * 极光推送
	 */
	public static void  sendMessage(MessageEntry msg) {
		String tagToken =msg.getToken();
		Long tagTenantId =msg.getTenantId();
		String tagIp =msg.getMsgIp();
		String msgType = msg.getMsgType();
		
		JPushClient jpushClient= new JPushClient("b378685649fdcda57d703d55", "2753cadd43696b7390fb562a", null,
