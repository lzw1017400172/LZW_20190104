...
import com.lzw.core.Constants.JOBSTATE;
import com.lzw.core.support.email.Email;
import com.lzw.core.support.mq.QueueSender;
import com.lzw.core.util.EmailUtil;
import com.lzw.core.util.NativeUtil;
import com.lzw.model.TaskFireLog;
		...
		executorService.submit(new Runnable() {
			public void run() {
				if (emailQueueSender != null) {
					emailQueueSender.send("lzw.emailSender", email);
				} else {
