...
public interface Constants {
    ...
    /** 缓存命名空间 */
    public static final String CACHE_NAMESPACE = "lzw:";
    /** 缓存命名空间token */
	 ...
	 * 【253云通讯】msg	regin
	 */
	public final static String MSG_REGIN = "【"+PropertiesUtil.getString("lzw.platform")+"】您正在注册验证，请在5分钟内按页面提示输入验证码，切勿将验证码泄露于他人。验证码:";
	/**
	 * 【253云通讯】msg	dynamic
	 */
	public final static String MSG_DYNAMIC = "【"+PropertiesUtil.getString("lzw.platform")+"】您正在获取动态密码，请在5分钟内按页面提示输入密码，切勿将密码泄露于他人。当前密码:";
	/**
	 * 【253云通讯】msg	retrieve
	 */
	public final static String MSG_RETRIEVE = "【"+PropertiesUtil.getString("lzw.platform")+"】您正在重置验证，请在5分钟内按页面提示输入验证码，切勿将验证码泄露于他人。验证码:";
	
	/**
	 * 【253云通讯】msg
	 */
	public final static String RESET_PWD = "【"+PropertiesUtil.getString("lzw.platform")+"】您好，你的密码重置为:";
	 ...
	 * 【253云通讯】rd
	 */
	public final static String DBURL = "jdbc:mysql://lzw.vicp.cc:8612/";
